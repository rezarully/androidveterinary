...
import com.rsh.android.rekammedisbosimrsh.models.modeluser.User;
import com.rsh.android.rekammedisbosimrsh.rest.RestApi;
import com.rsh.android.rekammedisbosimrsh.rest.RestApiLogin;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void loadJSON() {
        RestApiLogin apiService = ApiClient.getClient().create(RestApiLogin.class);
        Call<ModelUser> call = apiService.loadUser();
        call.enqueue(new Callback<ModelUser>() {
            @Override
            public void onResponse(Call<ModelUser> call, Response<ModelUser> response) {
                if (response.isSuccessful()){
                    List<User> pengguna = response.body().getUser();
                    userList = pengguna;
                    setupUser();
                }
            }
    ...
    private void setupUser(){
        ...
        for (int i = 0; i < userList.size(); i++) {
           ...
           /* SharedPreferences.Editor editor = sharedpreferences.edit();
            ...
            loginArray.add(username+":"+password);
        }
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            for (String credential : loginArray) {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                session.createLoginSession("RSH","Rekam Medis");
                finish();
